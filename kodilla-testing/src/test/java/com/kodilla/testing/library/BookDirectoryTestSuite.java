...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBookInHandsOf0BooksBorrowed() {
        //Given
        List<Book> resultListOf0Books = new ArrayList<>();
        LibraryUser libraryUser1 = new LibraryUser("Steven", "Kovalsky", "77041409112");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1)).thenReturn(resultListOf0Books);

        //When
        List<Book> theListOfBorrowedBooks0 = bookLibrary.listBookInHandsOf(libraryUser1);
    ...
    public void testListBookInHandsOf1BookBorrowed() {
        ...
        LibraryUser libraryUser1 = new LibraryUser("Steven", "Kovalsky", "477041409112");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1)).thenReturn(resultListOf1Book);

        //When
        List<Book> theListOfBorrowedBooks1 = bookLibrary.listBookInHandsOf(libraryUser1);
    ...
    public void testListBookInHandsOf5BooksBorrowed() {
        ...
        LibraryUser libraryUser1 = new LibraryUser("John", "Kovalsky", "377041404172");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1)).thenReturn(resultListOf5Books);

        //When
        List<Book> theListOfBorrowedBooks5 = bookLibrary.listBookInHandsOf(libraryUser1);
